...
public class AboutUs extends JFrame{
	...
	private JPanel contentPane;
        ...
        public AboutUs() {
            ...
            super("About Us - JIS College Of Engineerig");
            ...
            JLabel l6 = new JLabel("Developed By : Arindam Chatterjee");
            l6.setFont(new Font("Trebuchet MS", Font.BOLD, 30));
            l6.setBounds(70, 198, 600, 35);
            contentPane.add(l6);

            JLabel l7 = new JLabel("Roll Number - 123180703019");
            l7.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
            l7.setBounds(70, 260, 600, 34);
            contentPane.add(l7);

            JLabel l8 = new JLabel("Contact : arindamchatterjee.466@gmail.com");
            ...
            JLabel l10 = new JLabel("Phone - +91 7001730528");
